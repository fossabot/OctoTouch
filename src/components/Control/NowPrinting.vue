...
<template>
  <div fill-height fluid class="now-printing__container">
    ...
    <div class="now-printing__details">
      <v-row>
        ...
        <v-col class="now-printing__progress-below" v-ripple align="end">
          <span class="now-printing__details-title">
            {{job.filename.replace("ADMFOR25EX_","").replace(".ufp.gcode","").replace(/_/g, " ")}}
          </span><br>
          <span class="now-printing__details-subtitle">
      ...
      <v-row class="now-printing__overview">
        <v-col @click="cancelPrint().then(function() {update()})" v-ripple class="now-printing__overview-item">
